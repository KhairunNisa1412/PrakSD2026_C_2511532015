...
public class JamDriver2_2511532015 {
	...
	public static void main(String[] args) {
		...
		//1. Input Jam Pertama
		System.out.println ("\n--- Input Jam 1 ---");
		Jam_2511532015 j1 = buatJamDariInput (input);
		
		//2. Input Jam Kedua
		System.out.println ("\n--- Input Jam 2 ---");
		Jam_2511532015 j2 = buatJamDariInput (input);
		
		//3. Menampilkan data
		System.out.println ("\n--- Hasil Operasi ---");
		System.out.println ("Jam 1 (String)          : " + j1.toString());
		System.out.println ("Jam 1 (String)          : " + j2.toString());
		...
		System.out.println ("Durasi (J1 ke J2        : " + Jam_2511532015.durasiDetik(j1, j2) + "detik");
		
		Jam_2511532015 jNext = j1.nextSecond();
		System.out.println ("Jam 1 Detik Berikutnya  : " + jNext);
		
		Jam_2511532015 jPrev = j1.prevSecond();
		System.out.println ("Jam 1 Detik Sebelumnya  : " + jPrev);
		
		//6. Operasi Penjumlahan Jam
		Jam_2511532015 jHasilPlus = j1.plus(j2);
	 ...
	 */
	private static Jam_2511532015 buatJamDariInput(Scanner sc) {
		int h, m, s;
		while (true) {
		...
		if (Jam_2511532015.isValid(h, m, s)) {
			return new Jam_2511532015 (h, m, s);
		} else {
			System.out.println ("[ERROR] Inpuut tidak valid! Silahkan ulangi. \n");
		}
	}
