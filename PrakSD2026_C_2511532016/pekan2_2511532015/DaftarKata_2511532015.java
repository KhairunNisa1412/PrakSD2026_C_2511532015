...
public class DaftarKata_2511532015 {
	private final ArrayList<String> data;
	//Konstruktro: inisialisasi list kosong
	public DaftarKata_2511532015() {
		this.data= new ArrayList<>();
	}
	/**Menambahkan elemen di akhir list. */
	public void tambah_2511532015(String elemen) {
		data.add(elemen);
	}
	/** Menambahkan elemen pada indeks tertentu (menyisipkan). */
	public void tambahPada_2511532015 (int index, String elemen) {
	 ...
	 */
	public void ubahElemen_2511532015 (int index, String nilaiBaru) {
	...
	/**
	 * Melakukan iterai dan mencetak setiap elemen dalam format: [index] nilai
	 * (Metode ini tidak mengembalikan nilai; hanya demonstrasi iterasi).
	 */
	public void iterasiCetak_2511532015() {
